        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildFaqItem(
                context,
                'Qanday qilib ro‘yxatdan o‘taman?'.tr,
              ...
              _buildFaqItem(
                context,
                'Ilovada xatolik yuz berdi, nima qilish kerak?'.tr,
              ...
              _buildGuideItem(
                context,
                'Ilova bilan tanishish'.tr,
                'https://ishtopchi.uz/guide',
                () => _launchURL('https://ishtopchi.uz/guide'),
              ),
              SizedBox(height: Responsive.scaleHeight(6, context)),
              _buildGuideItem(
                context,
                'Xususiyatlarni foydalanish'.tr,
                'https://ishtopchi.uz/features',
                () => _launchURL('https://ishtopchi.uz/features'),
              ),
              SizedBox(height: Responsive.scaleHeight(6, context)),
              _buildGuideItem(
                context,
                'Profilni sozlamoqchimisiz?'.tr,
                'https://ishtopchi.uz/profile-setup',
                () => _launchURL('https://ishtopchi.uz/profile-setup'),
              ),
              SizedBox(height: Responsive.scaleHeight(16, context)),
