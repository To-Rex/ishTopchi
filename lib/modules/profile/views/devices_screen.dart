  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Mening qurilmalarim', style: TextStyle(color: AppColors.lightGray, fontSize: Responsive.scaleFont(20, context), fontWeight: FontWeight.bold))
      ),
      body: Container(
            ...
            child: ListView(
              ...
              children: [
                ...
                if (currentDevice != null) ...[
                  Text('Joriy qurilma', style: TextStyle(color: AppColors.lightGray, fontSize: Responsive.scaleFont(18, context), fontWeight: FontWeight.bold)),
                  SizedBox(height: Responsive.scaleHeight(8, context)),
                ...
                if (otherDevices.isNotEmpty) ...[
                  Text('Boshqa qurilmalar', style: TextStyle(color: AppColors.lightGray, fontSize: Responsive.scaleFont(18, context), fontWeight: FontWeight.bold)),
                  SizedBox(height: Responsive.scaleHeight(8, context)),
          ...
          children: [
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        isCurrentDevice ? '${device.deviceName ?? 'Noma’lum qurilma'} (Joriy)' : device.deviceName ?? 'Noma’lum qurilma',
                        style: TextStyle(
                          color: Colors.white,
            ...
            if (isCurrentDevice && otherDevices.isNotEmpty) ...[
              ...
              TextButton.icon(
                ...
                label: Text('Boshqa barcha seanslarni tugatish', style: TextStyle(color: AppColors.red, fontSize: Responsive.scaleFont(16, context), fontWeight: FontWeight.w600)),
