  ...
  Widget build(BuildContext context) {
    ...
    void showFilterDialog(BuildContext context, FuncController funcController, ApiController apiController) {
      ...
      if (funcController.categories.isEmpty) {
        apiController.fetchCategories().then((categories) {funcController.categories.assignAll(categories);});
      }
        ...
        transitionDuration: const Duration(milliseconds: 300),
          pageBuilder: (context, anim1, anim2) => Container(
            ...
            constraints: BoxConstraints(
              maxWidth: double.infinity * 0.95, // Ekran kengligining 85%
              minWidth: double.infinity * 0.9,  // Minimal kenglik
                        ...
                        children: [
                          ...
                          DropdownButtonFormField2<int>(
                            ...
                            decoration: InputDecoration(
                              label: Container(margin: EdgeInsets.only(left: Responsive.scaleWidth(20, context)), child: Text('Viloyat'.tr, style: TextStyle(color: AppColors.lightGray, fontSize: Responsive.scaleFont(14, context))),),
                            ...
                            dropdownStyleData: DropdownStyleData(maxHeight: 220.sp, decoration: BoxDecoration(
                            ...
                            items: funcController.regions.map((region) {
                              return DropdownMenuItem<int>(value: region['id'] as int, child: Text(region['name'].toString(),maxLines: 1, style: TextStyle(color: AppColors.white)));
                            }).toList(),
                          ...
                          // Tuman tanlash
                          funcController.isLoadingDistricts.value ? SizedBox(
                              height: AppDimensions.buttonHeight,
                              child: Center(child: CircularProgressIndicator(color: AppColors.lightBlue, strokeWidth: 2))) : DropdownButtonFormField2<int>(
                            value: funcController.selectedDistrict.value,
                            isExpanded: true,
                            decoration: InputDecoration(
                                label: Container(margin: EdgeInsets.only(left: Responsive.scaleWidth(20, context)), child: Text('Shahar/Tuman'.tr, style: TextStyle(color: AppColors.lightGray, fontSize: Responsive.scaleFont(14, context))),),
                                labelStyle: TextStyle(color: AppColors.lightGray, fontSize: Responsive.scaleFont(14, context)),
                                filled: true,
                                fillColor: AppColors.darkBlue.withOpacity(0.9),
                                border: OutlineInputBorder(borderRadius: BorderRadius.circular(12.sp), borderSide: BorderSide.none),
                            ...
                            items: funcController.districts.map((district) {
                              return DropdownMenuItem<int>(
                                ...
                                child: Text(district['name'].toString(), maxLines: 1, style: TextStyle(color: AppColors.white)),
                              );
                            }).toList(),
                            onChanged: (value) {
                              if (value != null) {
                          ...
                          DropdownButtonFormField2<String>(
                            ...
                            isExpanded: true,
                            decoration: InputDecoration(
                              label: Container(margin: EdgeInsets.only(left: Responsive.scaleWidth(20, context)), child: Text('Ish turi'.tr, style: TextStyle(color: AppColors.lightGray, fontSize: Responsive.scaleFont(14, context))),),
                              labelStyle: TextStyle(color: AppColors.lightGray, fontSize: Responsive.scaleFont(14, context)),
                              filled: true,
                              fillColor: AppColors.darkBlue.withOpacity(0.9),
                              border: OutlineInputBorder(borderRadius: BorderRadius.circular(12.sp), borderSide: BorderSide.none),
                          ...
                          DropdownButtonFormField2<String>(
                              ...
                              isExpanded: true,
                              decoration: InputDecoration(
                                label: Container(margin: EdgeInsets.only(left: Responsive.scaleWidth(20, context)), child: Text('Bandlik turi'.tr, style: TextStyle(color: AppColors.lightGray, fontSize: Responsive.scaleFont(14, context))),),
                                labelStyle: TextStyle(color: AppColors.lightGray, fontSize: Responsive.scaleFont(14, context)),
                                filled: true,
                                fillColor: AppColors.darkBlue.withOpacity(0.9),
                                border: OutlineInputBorder(borderRadius: BorderRadius.circular(12.sp), borderSide: BorderSide.none),
          ...
          transitionBuilder: (context, anim1, anim2, child) => FadeTransition(opacity: CurvedAnimation(parent: anim1, curve: Curves.easeInOut), child: ScaleTransition(scale: CurvedAnimation(parent: anim1, curve: Curves.easeOutBack), child: child))
      );
    }
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 6.sp),
                    Obx(() => Text(funcController.userMe.value != null ? funcController.userMe.value!.data!.district!.name ?? 'Viloyat'.tr : 'Viloyat'.tr, style: TextStyle(color: AppColors.lightGray, fontSize: Responsive.scaleFont(14, context), fontWeight: FontWeight.w500)))
                  ]
                )
              ),
              Spacer(),
